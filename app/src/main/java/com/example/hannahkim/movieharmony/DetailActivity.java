...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        theaterName.setText(intent.getStringExtra("theater_name"));

        movieName.setText(intent.getStringExtra("selectedMovie"));
                ...
                new AsyncTask() {//AsyncTask객체 생성
                    ...
                    protected Object doInBackground(Object[] params) {
                        ...
                        try {
                            ...
                            {
                                cnt++;
                                movie_name = timetable.select("a strong").text(); //영화 이름 저장

                                str+=cnt+". "+movie_name+"\n"; //str은 전체 영화+상영정보를 모두 합쳐서 보여줌.

                                //if(movie_name.equals("데드풀 2"))
                                //{
                                ...
                                for (Element tag : tags) {
                                    ...
                                    for (Element a_tag : li_tags) {
                                        ...
                                        //System.out.println(movie_name + " " + movie_time + " " + seat_count);
